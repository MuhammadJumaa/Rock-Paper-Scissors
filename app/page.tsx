...
export default function Home() {
  ...
  useEffect(() => {
    ...
    newSocket.on(
      "gameResult",
      ({ yourMove, opponentMove, result, opponentName, canRematch }) => {
      ...
      <Card className="w-full max-w-md p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            ...
            {gameState.status === "lobby" &&
              "Choose a game to join or create your own"}
            ...
            <div className="grid grid-cols-3 gap-3">
              {(["rock", "paper", "scissors"] as Move[]).map((move) => (
                <Button
                  key={move}
                  variant={
                    gameState.yourMove === move ? "secondary" : "outline"
                  }
        ...
        {gameState.status === "result" && (
          <div className="space-y-6 text-center">
            <div className="grid grid-cols-3 items-center gap-4">
              <div className="space-y-2">
                ...
                <div className="text-4xl">
                  {gameState.yourMove && moveIcons[gameState.yourMove]}
                </div>
              </div>
              <div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-4xl">
                  {gameState.opponentMove && moveIcons[gameState.opponentMove]}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Trophy
                className={`w-12 h-12 mx-auto ${getResultColor(
                  gameState.result
                )}`}
              />
              <p
